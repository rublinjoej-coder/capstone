...
(1, 2, 'ProBook Laptop 15"', 'High-performance laptop with 16GB RAM and 512GB SSD for power users.', 1299.99, 15, 'Electronics', 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=500'),
(2, 2, 'Wireless Noise-Canceling Headphones', 'Premium sound clarity with active noise cancellation and 30-hour battery life.', 249.50, 30, 'Electronics', 'https://images.unsplash.com/photo-1546435770-a3e426bf472b?w=500'),
(3, 2, 'Smart Fitness Watch', 'Track heart rate, workouts, sleep, and GPS activity with vibrant AMOLED display.', 199.99, 25, 'Electronics', 'https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=500'),
